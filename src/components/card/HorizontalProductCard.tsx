    ...
    return (
        <Badge.Ribbon text='off 10%' color='#f85606' className='text-xs' placement='start'>
            <div className='flex items-start cursor-pointer gap-2 bg-white rounded'>
                ...
                <div>
                    <h3 className='text-sm leading-5 line-clamp-2 hover:underline text-dark'>Indispensable -Quality And Durablity -OLEVS Leather Waterproof Quartz Fashion Watch for Men- Innovative Remarkable - Disclose Styles & Luxe</h3>
